/*
  ...
  - You are about to drop the column `sourceChapterIds` on the `Episode` table. All the data in the column will be lost.
  - Added the required column `chapterId` to the `Episode` table without a default value. This is not possible if the table is not empty.
